...
JNIEXPORT jboolean JNICALL Java_com_chaoying_ncnn_MobileNetSSD_Init(JNIEnv *env, jobject obj, jbyteArray param, jbyteArray bin){
...
JNIEXPORT jfloatArray JNICALL Java_com_chaoying_ncnn_MobileNetSSD_Detect(JNIEnv* env, jobject thiz, jobject bitmap){
    ncnn::Mat in;
    {
