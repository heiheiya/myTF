 ...
 * objects.
 */
public class HelmetDetectorActivity extends CameraActivity implements ImageReader.OnImageAvailableListener {
    ...
    private static final String TF_OD_API_MODEL_FILE = "coat_helmet_expand.tflite";
    private static final String TF_OD_API_LABELS_FILE = "file:///android_asset/coat_helmet_expand.txt";
